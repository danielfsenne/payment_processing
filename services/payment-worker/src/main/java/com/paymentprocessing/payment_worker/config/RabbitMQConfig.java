...
public class RabbitMQConfig {
    ...
    public static final String DLQ = "payment.worker.queue.dlq";
    ...
    @Bean
    public Queue paymentWorkerDeadLetterQueue() {
    ...
    @Bean
    public Binding paymentWorkerDeadLetterBinding(Queue paymentWorkerDeadLetterQueue, DirectExchange deadLetterExchange) {
        return BindingBuilder.bind(paymentWorkerDeadLetterQueue).to(deadLetterExchange).with(DLQ);
    }
