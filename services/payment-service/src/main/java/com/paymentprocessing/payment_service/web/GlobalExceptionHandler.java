...
import com.paymentprocessing.payment_service.statemachine.InvalidStateTransitionException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDownstreamUnavailable(DownstreamUnavailableException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleConcurrentOperation(ConcurrentOperationException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(body(HttpStatus.CONFLICT, ex.getMessage()));
    }
