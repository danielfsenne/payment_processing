...
import com.paymentprocessing.common.security.NotRevokedTokenValidator;
...
public class SecurityConfig {
    ...
    @Bean
    public JwtDecoder jwtDecoder(SecretKeySpec jwtSigningKey, RevokedTokenStore revokedTokenStore) {
